...
| `abstraction-laddering` | nie wiesz, czy rozwiazujesz wlasciwy problem |
...
| `ban-second-order-defaults` | pierwsze zakazy nie usunely sztampy |
...
| `debiasing` | przy waznym osadzie lub estymacji |
...
| `effectuation` | niepewnosc, gdy nie da sie zaplanowac od celu |
...
| `evidence-before-claims` | zanim oglosisz „gotowe / dziala / przechodzi” |
...
| `option-diversity` | zanim zaczniesz cokolwiek budowac/pisac |
...
| `quit-thinking-and-look` | bug/awaria, zanim zaczniesz zgadywac przyczyne |
...
| `triz-contradiction` | utknales w trade-offie „albo X, albo Y” |
